...
import { getStudio, createStudio, changeStudioName, changeStudioDesc } from '../stores/studioSampleSlice';



const StudioSamplePage = (props) => {
    ...
    const studioFromRedux = useSelector(state => state.studioSample);
...
export default StudioSamplePage;